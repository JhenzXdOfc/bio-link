...
const Profile = () => {
    const [imgSrc, setImgSrc] = useState(
        "https://files.catbox.moe/jti5cs.png"
    )
            ...
            <div className="text-center">
                <div className="inline-block relative">
                    <img
                        ...
                        onError={() =>
                            setImgSrc("https://files.catbox.moe/jti5cs.png")
                        }/>
                ...
                <div className="flex justify-center gap-4 mt-4 text-xl text-gray-400">
                    <a
                        href="https://instagram.com/JhenzXdOfc"
                        target="_blank"
                    ...
                    <a
                        href="https://github.com/JhenzXdOfc"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-zinc-400 hover:text-zinc-100 transition-colors">
                    ...
                    <a
                        href="https://www.tiktok.com/@JhenzXdOfc"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-zinc-400 hover:text-zinc-100 transition-colors">
